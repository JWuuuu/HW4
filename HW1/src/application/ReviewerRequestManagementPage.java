...
/**
 * ReviewerRequestManagementPage provides an interface for instructors
 * to manage reviewer requests. Instructors can approve or decline requests,
 * which updates the user's reviewerRequest flag and role accordingly.
 */
public class ReviewerRequestManagementPage {

    private final DatabaseHelper databaseHelper = new DatabaseHelper();
    private User currentUser;
    
    public ReviewerRequestManagementPage(User currentUser) {
    	this.currentUser = currentUser;
    }
    /**
     * Displays the Reviewer Request Management page.
